...
// Constants times :
#define kFlatDatePickerAnimationDuration 0.1
...
#define kFlatDatePickerScrollViewDaysWidth 80
#define kFlatDatePickerScrollViewMonthWidth 130
...
// Constants fonts
#define kFlatDatePickerFontTitle [UIFont fontWithName:@"HelveticaNeue-Light" size:14.0]
#define kFlatDatePickerFontLabel [UIFont fontWithName:@"HelveticaNeue-Regular" size:12.0]
#define kFlatDatePickerFontLabelSelected [UIFont fontWithName:@"HelveticaNeue-Bold" size:24.0]

// Constants icons
#define kFlatDatePickerIconCancel @"datepicker_exit@2x.png"
#define kFlatDatePickerIconValid @"datepicker_select@2x.png"
...
-(id)initWithParentView:(UIView*)parentView {
    ...
    if ([self initWithFrame:CGRectMake(0.0, 30, _parentView.frame.size.width, kFlatDatePickerHeight)]) {
        [self setupControl];
    }
    return self;
}
...
- (void)buildHeader {
    ...
    // Button Cancel
    _buttonClose = [[UIButton alloc] initWithFrame:CGRectMake(0.0, 0.0, 40, kFlatDatePickerHeaderHeight)];
    ...
    [_buttonClose setAutoresizingMask:UIViewAutoresizingFlexibleHeight];
    [_buttonClose setAutoresizingMask:UIViewAutoresizingFlexibleWidth];
    
    [self addSubview:_buttonClose];
    
    UIView* viewSeparator = [[UIView alloc] initWithFrame:CGRectMake(40, 0.0, 5, kFlatDatePickerHeaderHeight)];
    [viewSeparator setBackgroundColor:[UIColor whiteColor]];
...
//    _buttonValid = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width - kFlatDatePickerButtonHeaderWidth, 0.0, kFlatDatePickerButtonHeaderWidth, kFlatDatePickerHeaderHeight)];
     ...
     _buttonValid = [[UIButton alloc] initWithFrame:CGRectMake(45, 0, self.frame.size.width - 45, kFlatDatePickerHeaderHeight)];
    
    NSLog(@"_buttonValid : %@",[_buttonValid description]);
    ...
    [_buttonValid setAutoresizingMask:UIViewAutoresizingFlexibleHeight];
    [_buttonValid setAutoresizingMask:UIViewAutoresizingFlexibleWidth];
