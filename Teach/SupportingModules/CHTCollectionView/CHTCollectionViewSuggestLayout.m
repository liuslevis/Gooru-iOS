...
@interface CHTCollectionViewSuggestLayout ()
...
@implementation CHTCollectionViewSuggestLayout
...
- (void)prepareLayout {
    ...
    if ([self.delegate respondsToSelector:@selector(collectionView:heightForHeaderInLayout:)]) {
        CGFloat headerHeight = [self.delegate collectionViewSuggest:self.collectionView
    ...
    for (idx = 0; idx < _itemCount; idx++) {
        ...
        CGFloat itemHeight = [self.delegate collectionViewSuggest:self.collectionView
                                                    layout:self
    ...
    if ([self.delegate respondsToSelector:@selector(collectionView:heightForFooterInLayout:)]) {
        CGFloat footerHeight = [self.delegate collectionViewSuggest:self.collectionView
